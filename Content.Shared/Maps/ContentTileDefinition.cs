...
namespace Content.Shared.Maps
{
    ...
    public sealed partial class ContentTileDefinition : IPrototype, IInheritingPrototype, ITileDefinition
    {
        ...
        public string? ItemDropPrototypeName { get; private set; } = null; //OE14 default null
        ...
        /// <summary>
        /// OE14 - If not empty, the tile can burn from fires, and will turn into the specified tile after burning.
        /// </summary>
        [DataField]
