...
public sealed partial class ConstructionPrototype : IPrototype
{
    ...
    /// <summary>
    /// OE14 - Some recipes are not available until certain conditions are met.
    /// </summary>
    [DataField]
    public List<OE14SkillRestriction> OE14Restrictions = new();
    ...
    /// </summary>
    [DataField]
    public bool OpenEdgeAllowed = false;
}
