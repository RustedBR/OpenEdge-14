...
public abstract class SharedArmorSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ArmorComponent, ExaminedEvent>(OnArmorExamine);
    }
    ...
    private void OnArmorExamine(EntityUid uid, ArmorComponent component, ExaminedEvent args)
    {
        if (!args.IsInDetailsRange || !component.ShowArmorOnExamine)
            return;
        ...
        args.PushMessage(examineMarkup, -2);
    }
    ...
    //OE14 public armor edit API end
}
