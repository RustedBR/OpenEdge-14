...
[UsedImplicitly]
[DataDefinition]
public sealed partial class OE14NoRoofInTile : IConstructionCondition
{
    public ConstructionGuideEntry GenerateGuideEntry()
    {
        return new ConstructionGuideEntry
        {
            Localization = "oe14-construction-step-condition-no-roof-in-tile",
        };
    }
    ...
    public bool Condition(EntityUid user, EntityCoordinates location, Direction direction)
    {
        ...
        {
            if (entityManager.HasComponent<OE14RoofComponent>(entt))
            {
                return false;
            }
        }
