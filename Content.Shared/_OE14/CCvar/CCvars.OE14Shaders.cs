...
public sealed partial class CCVars
{
    public static readonly CVarDef<bool>
        WaveShaderEnabled = CVarDef.Create("oe14_shaders.wave_shader_enabled", true, CVar.CLIENT | CVar.ARCHIVE);
    ...
    /// </summary>
    public static readonly CVarDef<bool>
        PostProcess = CVarDef.Create("oe14_shaders.post_process", true, CVar.CLIENTONLY | CVar.ARCHIVE);
}
