...
namespace Content.Shared._OE14.Workbench.Requirements;

public sealed partial class StackGroupResource : OE14WorkbenchCraftRequirement
{
    [DataField(required: true)]
    public ProtoId<OE14StackGroupPrototype> Group;
    ...
    public override double GetPrice(IEntityManager entManager, IPrototypeManager protoManager)
    {
        ...
        foreach (var stack in indexedGroup.Stacks)
        {
            ...
            var priceSys = entManager.System<OE14SharedStationEconomySystem>();
