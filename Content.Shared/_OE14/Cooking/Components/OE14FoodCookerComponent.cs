...
/// </summary>
[RegisterComponent, NetworkedComponent, AutoGenerateComponentState(fieldDeltas: true), Access(typeof(OE14SharedCookingSystem))]
public sealed partial class OE14FoodCookerComponent : Component
{
    ...
    [DataField]
    public EntProtoId? BurntAdditionalSpawn = "OE14Fire";
...
[Serializable]
[DataDefinition]
public sealed partial class OE14FoodData
{
    public OE14FoodData(OE14FoodData data)
    {
    ...
    [DataField]
    public ProtoId<OE14CookingRecipePrototype>? CurrentRecipe;
...
public enum OE14CookingVisuals : byte
{
    Cooking,
    Burning,
}
