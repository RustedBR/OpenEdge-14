...
/// </summary>
[RegisterComponent, NetworkedComponent, AutoGenerateComponentPause, AutoGenerateComponentState(true), Access(typeof(OE14SharedFarmingSystem))]
public sealed partial class OE14PlantComponent : Component
{
    /// <summary>
...
/// </summary>
public sealed class OE14PlantUpdateEvent(Entity<OE14PlantComponent> comp) : EntityEventArgs
{
    public readonly Entity<OE14PlantComponent> Plant = comp;
    public float EnergyDelta = 0f;
    public float ResourceDelta = 0f;
}

/// <summary>
/// is called after OE14PlantUpdateEvent when all value changes have already been calculated.
/// </summary>
public sealed class OE14AfterPlantUpdateEvent(Entity<OE14PlantComponent> comp) : EntityEventArgs
{
    public readonly Entity<OE14PlantComponent> Plant = comp;
}
