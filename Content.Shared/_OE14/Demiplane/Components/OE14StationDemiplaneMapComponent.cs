namespace Content.Shared._OE14.Demiplane.Components;

/// <summary>
/// A station component that stores information about the current map of demiplanes, their research status and relationships.
/// </summary>
[RegisterComponent]
public sealed partial class OE14StationDemiplaneMapComponent : Component
{
    [DataField]
    public Dictionary<Vector2i, OE14DemiplaneMapNode> Nodes = new();
