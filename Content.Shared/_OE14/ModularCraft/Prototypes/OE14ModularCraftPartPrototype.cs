...
public sealed partial class OE14ModularCraftPartPrototype : IPrototype
{
    [IdDataField]
    public string ID { get; private set; } = default!;

    [DataField]
    public List<ProtoId<OE14ModularCraftSlotPrototype>> Slots = new();
    ...
    public List<OE14ModularCraftModifier> Modifiers = new();
