...
public sealed class OE14EditTileToolSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<OE14EditTileToolComponent, AfterInteractEvent>(OnTileClick);
        SubscribeLocalEvent<OE14EditTileToolComponent, OE14TileToolReplaceDoAfter>(OnDoAfterEnd);
    }

    private void OnTileClick(Entity<OE14EditTileToolComponent> ent, ref AfterInteractEvent args)
    {
        ...
        var doAfterArgs =
            new DoAfterArgs(EntityManager,
                args.User,
                ent.Comp.Delay,
                new OE14TileToolReplaceDoAfter(GetNetCoordinates(args.ClickLocation)),
                ent)
            {
                BreakOnDamage = true,
    ...
    private void OnDoAfterEnd(Entity<OE14EditTileToolComponent> ent, ref OE14TileToolReplaceDoAfter args)
    {
