...
public sealed class OE14CalculateManacostEvent : EntityEventArgs, IInventoryRelayEvent
{
    ...
    public OE14CalculateManacostEvent(EntityUid? performer, FixedPoint2 initialManacost)
    {
        Performer = performer;
...
[ByRefEvent]
public sealed class OE14SpellFromSpellStorageUsedEvent(
    EntityUid? performer,
    EntityUid? action,
