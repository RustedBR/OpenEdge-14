...
public sealed partial class OE14LockComponent : Component
{
    ...
    /// </summary>
    [DataField]
    public ProtoId<OE14LockTypePrototype>? AutoGenerateShape = null;
    ...
    [DataField]
    public SoundSpecifier EmbedSound = new SoundPathSpecifier("/Audio/_OE14/Items/lockpick_use.ogg")
    {
