...
public abstract partial class OE14SharedStationEconomySystem
{
    ...
    private double GetMaterialsPrice(EntityPrototype prototype)
    {
        ...
        //OE14 We take materials into account when calculating the price in any case.
        if ((prototype.Components.ContainsKey(Factory.GetComponentName<MaterialComponent>()) || prototype.ID.StartsWith("OE14")) &&
