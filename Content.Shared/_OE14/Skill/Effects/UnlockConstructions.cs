...
/// </summary>
public sealed partial class UnlockConstructions : OE14SkillEffect
{
    ...
    public override string? GetDescription(IEntityManager entMagager, IPrototypeManager protoManager, ProtoId<OE14SkillPrototype> skill)
    {
        ...
        sb.Append(Loc.GetString("oe14-skill-desc-unlock-constructions") + "\n");

        var affectedRecipes = new List<ConstructionPrototype>();
        foreach (var recipe in allRecipes)
        {
            foreach (var req in recipe.OE14Restrictions)
            {
