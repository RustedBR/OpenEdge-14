...
using Content.Shared._OE14.Skill.Effects;
...
/// </summary>
[Prototype("oe14Skill")]
public sealed partial class OE14SkillPrototype : IPrototype
{
    ...
    public ProtoId<OE14SkillTreePrototype> Tree = default!;
    ...
    /// </summary>
    [DataField]
    public List<OE14SkillEffect> Effects = new();

    /// <summary>
    /// Skill restriction. Limiters on learning. Any reason why a player cannot learn this skill.
    /// </summary>
    [DataField]
    public List<OE14SkillRestriction> Restrictions = new();
}
