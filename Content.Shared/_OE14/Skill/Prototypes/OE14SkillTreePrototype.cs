...
/// </summary>
[Prototype("oe14SkillTree")]
public sealed partial class OE14SkillTreePrototype : IPrototype
{
    ...
    [DataField(required: true)]
    public ProtoId<OE14SkillPointPrototype> SkillType;
    ...
    [DataField]
    public SoundSpecifier LearnSound = new SoundCollectionSpecifier("OE14LearnSkill");
}
