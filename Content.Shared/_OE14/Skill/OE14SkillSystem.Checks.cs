...
public abstract partial class OE14SharedSkillSystem
{
    ...
    {
        SubscribeLocalEvent<OE14MeleeWeaponSkillRequiredComponent, MeleeHitEvent>(OnMeleeAttack);
        SubscribeLocalEvent<OE14MeleeWeaponSkillRequiredComponent, ExaminedEvent>(OnExamined);
    }

    private void OnExamined(Entity<OE14MeleeWeaponSkillRequiredComponent> ent, ref ExaminedEvent args)
    {
        var sb = new StringBuilder();
        sb.Append(Loc.GetString("oe14-skill-issue-title") + "\n");
    ...
    private void OnMeleeAttack(Entity<OE14MeleeWeaponSkillRequiredComponent> ent, ref MeleeHitEvent args)
    {
        ...
        _popup.PopupEntity(Loc.GetString("oe14-skill-issue"), args.User, args.User, PopupType.Medium);
    }
}
