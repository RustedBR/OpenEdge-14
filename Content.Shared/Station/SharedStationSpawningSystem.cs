...
public abstract class SharedStationSpawningSystem : EntitySystem
{
    ...
    [Dependency] private readonly SharedActionsSystem _action = default!; //OE14
    [Dependency] private readonly OE14SharedSkillSystem _skill = default!; //OE14
    ...
    public void EquipStartingGear(EntityUid entity, LoadoutPrototype loadout, bool raiseEvent = true)
    {
        ...
        OE14EquipStartingActions(entity, loadout); //OE14
    }

    private void OE14EquipStartingActions(EntityUid entity, LoadoutPrototype loadout)
    {
