...
namespace Content.Shared.Chemistry.Reaction
{
    ...
    public sealed partial class ReactionPrototype : IPrototype, IComparable<ReactionPrototype>
    {
        ...
        [DataField("sound", serverOnly: true)] public SoundSpecifier? Sound { get; private set; } = new SoundCollectionSpecifier("OE14Bubbles", AudioParams.Default.WithVariation(0.2f)); //OE14 nullable
