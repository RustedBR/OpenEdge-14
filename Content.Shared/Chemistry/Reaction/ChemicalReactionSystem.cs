...
namespace Content.Shared.Chemistry.Reaction
{
    public sealed class ChemicalReactionSystem : EntitySystem
    {
        ...
        /// </summary>
        private const int MaxReactionIterations = 50; //20 standard, OE14 increase limit
        ...
        {
            var args = new EntityEffectReagentArgs(soln, EntityManager, null, soln.Comp.Solution, unitReactions, reagent, null, 1f, soln); //OE14 soln add
