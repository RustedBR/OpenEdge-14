...
namespace Content.Shared.Preferences
{
    ...
    {
        private static readonly Regex RestrictedNameRegex = new("[^А-Я,а-я,A-Z,a-z,0-9, ,\\-,']"); //OE14 Cyrillic add
        ...
        // OE14: Stat bonuses chosen during character creation (additive on top of race base stats).
        [DataField]
        public int OE14StatBonusStrength { get; set; } = 0;

        [DataField]
        public int OE14StatBonusVitality { get; set; } = 0;

        [DataField]
        public int OE14StatBonusDexterity { get; set; } = 0;

        [DataField]
        public int OE14StatBonusIntelligence { get; set; } = 0;
        ...
        {
            // OE14: copy stat bonuses — not in the base constructor so must be set explicitly.
            OE14StatBonusStrength = other.OE14StatBonusStrength;
            OE14StatBonusVitality = other.OE14StatBonusVitality;
            OE14StatBonusDexterity = other.OE14StatBonusDexterity;
            OE14StatBonusIntelligence = other.OE14StatBonusIntelligence;
        }
        ...
        // OE14: Returns a new profile with the given stat bonus set.
        public HumanoidCharacterProfile WithOE14StatBonus(string stat, int value)
        {
            return stat.ToLowerInvariant() switch
            {
                "strength" => new(this) { OE14StatBonusStrength = value },
                "vitality" => new(this) { OE14StatBonusVitality = value },
                "dexterity" => new(this) { OE14StatBonusDexterity = value },
                "intelligence" => new(this) { OE14StatBonusIntelligence = value },
                _ => this,
            };
        }
        ...
        public bool MemberwiseEquals(ICharacterProfile maybeOther)
        {
            ...
            if (OE14StatBonusStrength != other.OE14StatBonusStrength) return false;
            if (OE14StatBonusVitality != other.OE14StatBonusVitality) return false;
            if (OE14StatBonusDexterity != other.OE14StatBonusDexterity) return false;
            if (OE14StatBonusIntelligence != other.OE14StatBonusIntelligence) return false;
