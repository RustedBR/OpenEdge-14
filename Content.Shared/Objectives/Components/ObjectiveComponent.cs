...
/// </summary>
[ByRefEvent]
public record struct ObjectiveAfterAssignEvent(EntityUid? MindId, MindComponent? Mind, ObjectiveComponent Objective, MetaDataComponent Meta); //OE14 add ? to mindId and Mind. For Common goals
