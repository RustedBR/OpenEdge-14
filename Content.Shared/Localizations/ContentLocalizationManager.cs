...
namespace Content.Shared.Localizations
{
    public sealed class ContentLocalizationManager
    {
        ...
        public void Initialize()
        {
            ...
            //OE14 Boilerplate! Should be deleted when https://github.com/space-wizards/space-station-14/pull/34404 is merged
            _loc.Initialize();
            //OE14 Boilerplate end
        ...
        private ILocValue FormatNaturalPercent(LocArgs args)
        {
            ...
            var formatter = (NumberFormatInfo)NumberFormatInfo.GetInstance(CultureInfo.GetCultureInfo(_cfg.GetCVar(CCVars.Language))).Clone();
