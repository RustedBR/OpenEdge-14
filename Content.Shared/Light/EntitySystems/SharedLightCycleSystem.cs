...
public abstract class SharedLightCycleSystem : EntitySystem
{
    ...
    {
        //OE14DayCycleSystem
        EnsureComp<OE14DayCycleComponent>(ent);
        //OE14DayCycleSystem end
        ...
        float phase = 0)
    {
        ...
        var sen = MathF.Pow(MathF.Cos((MathF.PI * (phase + x)) / waveLength), exponent); //OE14 edited light curve calculation
