...
public abstract class SharedStorageSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        CommandBinds.Builder
            ...
            //OE14
            .Bind(OE14ContentKeyFunctions.OpenBelt2, InputCmdHandler.FromDelegate(HandleOpenBelt2, handle: false))
            //OE14 end
    ...
    private void OnInteractUsing(EntityUid uid, StorageComponent storageComp, InteractUsingEvent args)
    {
        ...
        if (_whitelistSystem.IsWhitelistPass(storageComp.OE14Ignorelist, args.Used))
            return;
