...
public sealed class PassiveDamageSystem : EntitySystem
{
    ...
    private EntityQuery<MobStateComponent> _mobStateQuery; //OE14

    public override void Initialize()
    {
        base.Initialize();

        _mobStateQuery = GetEntityQuery<MobStateComponent>(); //OE14
