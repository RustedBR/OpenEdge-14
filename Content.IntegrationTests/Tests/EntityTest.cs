    ...
    public sealed class EntityTest
    {
        ...
        public async Task SpawnAndDeleteAllEntitiesOnDifferentMaps()
        {
            ...
            await server.WaitPost(() =>
            {
                var protoIds = prototypeMan
                    ...
                    //OE14
                    .Where(p => !p.Components.ContainsKey("OE14BiomeSpawner")) // this component delete all entities on this tile
                    .Where(p => !p.Components.ContainsKey("OE14AreaEntityEffect")) // lightning detonates entities
                    //OE14 end
                    .Select(p => p.ID)
                    .ToList();
        ...
        public async Task SpawnAndDeleteAllEntitiesInTheSameSpot()
        {
            ...
            await server.WaitPost(() =>
            {
                ...
                var protoIds = prototypeMan
                    ...
                    .Where(p => !p.Components.ContainsKey("RoomFill")) // This comp can delete all entities, and spawn others
                    //OE14
                    .Where(p => !p.Components.ContainsKey("OE14BiomeSpawner")) // OE14 this component delete all entities on this tile
                    .Where(p => !p.Components.ContainsKey("OE14AreaEntityEffect")) // OE14 lightning detonates entities
                    //OE14 end
                    .Select(p => p.ID)
                    .ToList();
                foreach (var protoId in protoIds)
        ...
        public async Task SpawnAndDirtyAllEntities()
        {
            ...
            var protoIds = prototypeMan
                ...
                .Where(p => !p.Components.ContainsKey("MapGrid")) // This will smash stuff otherwise.
                //OE14
                .Where(p => !p.Components.ContainsKey("OE14VampireClanHeart")) //Spawn announcement sound entities on init
                //OE14 end
                .Select(p => p.ID)
                .ToList();
        ...
        public async Task SpawnAndDeleteEntityCountTest()
        {
            ...
            var excluded = new[]
            {
                ...
                "AnnounceOnSpawn",
                //OE14
                "OE14VampireClanHeart", //Also announce on spawn
                //OE14 end
            };
