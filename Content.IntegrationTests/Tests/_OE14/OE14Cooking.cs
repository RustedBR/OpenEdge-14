...
[TestFixture]
public sealed class OE14Cooking
{
    [Test]
    public async Task TestAllCookingRecipeIsCookable()
    {
        ...
        var cookSys = entManager.System<OE14SharedCookingSystem>();

        await server.WaitAssertion(() =>
        {
            Assert.Multiple(() =>
            {
                foreach (var recipe in protoMan.EnumeratePrototypes<OE14CookingRecipePrototype>())
                {
