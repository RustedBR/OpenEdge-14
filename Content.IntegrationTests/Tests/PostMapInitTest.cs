...
namespace Content.IntegrationTests.Tests
{
    ...
    public sealed class PostMapInitTest
    {
        ...
        {
            //CrystallEdge Maps
            "/Maps/_OE14/dev_map.yml",
            "/Maps/_OE14/Dungeon/artifact_room.yml",
                ...
                */ //OE14 Disable FTL test
                if (entManager.HasComponent<StationJobsComponent>(station))
                {
                    ...
                    var spawnPoints = entManager.EntityQuery<SpawnPointComponent>()
                        .Where(x => x.SpawnType is SpawnPointType.Job or SpawnPointType.Unset && x.Job != null) //OE14 Job or Unset (only Job in upstream)
