...
public sealed partial class StencilOverlay
{
    ...
    private void DrawWeather(in OverlayDrawArgs args, WeatherPrototype weatherProto, float alpha, Matrix3x2 invMatrix)
    {
        ...
        var eye = args.Viewport.Eye; //OE14
        ...
        worldHandle.RenderInRenderTarget(_blep!, () =>
        {
            ...
            foreach (var grid in _grids)
            {
                ...
                foreach (var tile in _map.GetTilesIntersecting(grid.Owner, grid, worldAABB))
                {
                    ...
                    //OE14 offset - required for isometric walls
                    if (eye is not null)
                    {
        ...
        _parallax.DrawParallax(worldHandle, worldAABB, sprite, curTime, position, weatherProto.OffsetSpeed, modulate: (weatherProto.Color ?? Color.White).WithAlpha(alpha*weatherProto.Alpha)); //OE14 alpha and offset scrolling
