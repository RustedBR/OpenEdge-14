using Content.Client._OE14.UserInterface.Systems.Skill;
...
public sealed class GameTopMenuBarUIController : UIController
{
    ...
    [Dependency] private readonly OE14SkillUIController _skill = default!; //OE14
