using Content.Client._OE14.Discord;
using Content.Client._OE14.JoinQueue;
using Content.Client._OE14.Input;
...
namespace Content.Client.Entry
{
    public sealed class EntryPoint : GameClient
    {
        ...
        [Dependency] private readonly IOE14SponsorManager _sponsorManager = default!;
        //OE14 end
        ...
        public override void PostInit()
        {
            ...
            //OE14
            OE14ContentContexts.SetupContexts(_inputManager.Contexts);
            _overlayManager.AddOverlay(new OE14BasePostProcessOverlay());
