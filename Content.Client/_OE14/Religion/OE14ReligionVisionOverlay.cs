...
public sealed class OE14ReligionVisionOverlay : Overlay
{
    ...
    private readonly ProtoId<OE14ReligionPrototype>? _religion;
    ...
    public OE14ReligionVisionOverlay()
    {
        IoCManager.InjectDependencies(this);

        _religionShader = _proto.Index<ShaderPrototype>("OE14ReligionVision").InstanceUnique();

        _transform = _entManager.System<SharedTransformSystem>();

        if (_entManager.TryGetComponent<OE14ReligionEntityComponent>(_player.LocalEntity, out var vision))
    ...
    protected override bool BeforeDraw(in OverlayDrawArgs args)
    {
        ...
        var religionQuery = _entManager.AllEntityQueryEnumerator<OE14ReligionObserverComponent, TransformComponent>();
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        if (!_entManager.TryGetComponent<OE14ReligionVisionComponent>(_player.LocalEntity, out var visionComponent))
            return;
