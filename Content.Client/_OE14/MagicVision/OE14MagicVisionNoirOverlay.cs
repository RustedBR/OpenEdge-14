...
public sealed class OE14MagicVisionNoirOverlay : Overlay
{
    ...
    public OE14MagicVisionNoirOverlay()
    {
        IoCManager.InjectDependencies(this);
        _noirShader = _prototypeManager.Index<ShaderPrototype>("OE14BlueNoir").InstanceUnique();
