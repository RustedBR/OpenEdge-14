...
public sealed class OE14MagicEnergyStatusControl : Control
{
    private readonly Entity<OE14MagicEnergyContainerComponent> _parent;
    private readonly IEntityManager _entMan;
    private readonly RichTextLabel _label;
    private readonly ProgressBar _progress;

    public OE14MagicEnergyStatusControl(Entity<OE14MagicEnergyExaminableComponent> parent)
    {
        ...
        if (!_entMan.TryGetComponent<OE14MagicEnergyContainerComponent>(parent, out var container))
            return;
