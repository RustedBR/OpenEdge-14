...
namespace Content.Client._OE14.UserInterface;

[GenerateTypedNameReferences]
public sealed partial class OE14PriceControl : Control
{
    [Dependency] private readonly IEntityManager _entity = default!;

    private readonly SpriteSystem _sprite;

    public OE14PriceControl(int price)
    {
        ...
        var rsiPath = new ResPath("_OE14/Interface/Misc/coins.rsi");
