...
public sealed class OE14ShowVampireIconsSystem : EquipmentHudSystem<OE14ShowVampireFactionComponent>
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<OE14VampireComponent, GetStatusIconsEvent>(OnGetStatusIcons);
    }

    private void OnGetStatusIcons(Entity<OE14VampireComponent> ent, ref GetStatusIconsEvent args)
    {
        ...
        if (TryComp<OE14ShowVampireFactionComponent>(_player.LocalEntity, out var showIcons) &&
