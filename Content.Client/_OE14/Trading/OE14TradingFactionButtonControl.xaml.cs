...
public sealed partial class OE14TradingFactionButtonControl : Control
{
    public event Action? OnPressed;

    public OE14TradingFactionButtonControl(Color color, string label, FixedPoint2 reputation)
    {
