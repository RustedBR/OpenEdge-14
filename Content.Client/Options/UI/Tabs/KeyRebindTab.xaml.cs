...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class KeyRebindTab : Control
    {
        ...
        public KeyRebindTab()
        {
            ...
            //OE14
            AddHeader("ui-options-header-oe14");
            AddButton(OE14ContentKeyFunctions.OE14OpenSkillMenu);
            AddButton(OE14ContentKeyFunctions.OpenBelt2);
            AddButton(OE14ContentKeyFunctions.SmartEquipBelt2);
            //OE14 end
