...
namespace Content.Client.Ghost
{
    public sealed class GhostSystem : SharedGhostSystem
    {
        ...
        private void OnGhostRemove(EntityUid uid, GhostComponent component, ComponentRemove args)
        {
            ...
            //_actions.RemoveAction(uid, component.ToggleGhostHearingActionEntity); //Dont need in OE14
            //OE14
            _actions.RemoveAction(uid, component.OE14ToggleRoofActionEntity);
            _actions.RemoveAction(uid, component.OE14RespawnActionEntity);
            //OE14 end
