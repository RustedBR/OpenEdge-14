...
public sealed partial class ContentAudioSystem
{
   ...
   private void OE14UpdateAmbientLoops()
   {
   ...
   private void StartAmbientLoop(OE14AmbientLoopPrototype proto)
   {
   ...
   private void StopAmbientLoop(OE14AmbientLoopPrototype proto)
   {
   ...
   /// </summary>
   /// <returns></returns>
   private List<OE14AmbientLoopPrototype> GetAmbientLoops()
   {
       List<OE14AmbientLoopPrototype> list = new();
       ...
       var ambientLoops = _proto.EnumeratePrototypes<OE14AmbientLoopPrototype>().ToList();
