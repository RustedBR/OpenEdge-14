...
round-end-summary-window-player-manifest-tab-title = Lista de Jogadores
...
round-end-summary-window-duration-label = Ela durou [color=yellow]{$hours} horas, {$minutes} minutos e {$seconds} segundos.
...
round-end-summary-window-player-info-if-not-observer-text = [color=gray]{$playerOOCName}[/color] era [color={$icNameColor}]{$playerICName}[/color] jogando o papel de [color=orange]{$playerRole}[/color].