...
door-remote-toggle-bolt-text = Alterna Trancadores
...
door-remote-switch-state-toggle-bolts = Você muda o controle para alternar trancadores
door-remote-switch-state-toggle-emergency-access = Você muda o controle para alternar acesso de emergência
door-remote-no-power = A porta não está energizada
