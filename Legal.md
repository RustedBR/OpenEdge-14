...
- Unless specified otherwise, all Source Code, inside any **\_OE14 or OE14 folders**, fall under the terms specified in LICENSE_CE.TXT *with Exhibit B enforced* and the [CrystallEdge CLA](https://github.com/crystallpunk-14/crystall-punk-14/blob/master/CLA.md). All assets/content in those folders fall under CC-BY-SA 4.0.
