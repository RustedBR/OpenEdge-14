...
namespace Content.Server.Database
{
    ...
    public class Profile
    {
        ...
        // OE14: stat points allocated during character creation
        [Column("oe14_stat_str")] public int OE14StatBonusStrength { get; set; } = 0;
        [Column("oe14_stat_vit")] public int OE14StatBonusVitality { get; set; } = 0;
        [Column("oe14_stat_dex")] public int OE14StatBonusDexterity { get; set; } = 0;
        [Column("oe14_stat_int")] public int OE14StatBonusIntelligence { get; set; } = 0;
