...
public sealed partial class AdminVerbSystem
{
    ...
    //OE14
    private static readonly EntProtoId OE14VampireUnnameable = "OE14GameRuleVampireClanUnnameable";
    private static readonly EntProtoId OE14VampireDevourers = "OE14GameRuleVampireClanDevourers";
    private static readonly EntProtoId OE14VampireNightChildrens = "OE14GameRuleVampireClanNightChildrens";
    //OE14 end
    ...
    private void AddAntagVerbs(GetVerbsEvent<Verb> args)
    {
        ...
        Verb vampire3 = new()
        {
            Text = Loc.GetString("oe14-admin-verb-text-make-vampire") + ": " + Loc.GetString("oe14-vampire-fraction-name-night-childrens"),
            Category = VerbCategory.Antag,
            Icon = new SpriteSpecifier.Rsi(new ResPath("/Textures/_OE14/Interface/Misc/vampire_icons.rsi"), "NightChildrens"),
            Act = () =>
            {
                _antag.ForceMakeAntag<OE14VampireRuleComponent>(targetPlayer, OE14VampireNightChildrens);
            },
            Impact = LogImpact.High,
            Message = Loc.GetString("oe14-admin-verb-make-vampire"),
        };
        args.Verbs.Add(vampire3);

        Verb vampire2 = new()
        {
            Text = Loc.GetString("oe14-admin-verb-text-make-vampire") + ": " + Loc.GetString("oe14-vampire-fraction-name-devourers"),
            Category = VerbCategory.Antag,
            Icon = new SpriteSpecifier.Rsi(new ResPath("/Textures/_OE14/Interface/Misc/vampire_icons.rsi"), "Devourers"),
            Act = () =>
            {
                _antag.ForceMakeAntag<OE14VampireRuleComponent>(targetPlayer, OE14VampireDevourers);
            },
            Impact = LogImpact.High,
            Message = Loc.GetString("oe14-admin-verb-make-vampire"),
        };
        ...
        Verb vampire1 = new()
        {
            Text = Loc.GetString("oe14-admin-verb-text-make-vampire") + ": " + Loc.GetString("oe14-vampire-fraction-name-unnameable"),
            Category = VerbCategory.Antag,
            Icon = new SpriteSpecifier.Rsi(new ResPath("/Textures/_OE14/Interface/Misc/vampire_icons.rsi"), "Unnameable"),
            Act = () =>
            {
                _antag.ForceMakeAntag<OE14VampireRuleComponent>(targetPlayer, OE14VampireUnnameable);
            },
            Impact = LogImpact.High,
            Message = Loc.GetString("oe14-admin-verb-make-vampire"),
        };
