...
public sealed class CrayonSystem : SharedCrayonSystem
{
    ...
    private void OnCrayonBoundUI(EntityUid uid, CrayonComponent component, CrayonSelectMessage args)
    {
        ...
        if (!_prototypeManager.TryIndex<DecalPrototype>(args.State, out var prototype) || !prototype.Tags.Contains("OE14crayon")) //OE14 crayon
            return;
    ...
    private void OnCrayonInit(EntityUid uid, CrayonComponent component, ComponentInit args)
    {
        ...
        var decal = _prototypeManager.EnumeratePrototypes<DecalPrototype>().FirstOrDefault(x => x.Tags.Contains("OE14crayon")); //OE14 crayon
