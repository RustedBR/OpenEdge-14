...
public sealed partial class ShuttleSystem
{
    ...
    private readonly SoundSpecifier _startupSound = new SoundPathSpecifier("/Audio/_OE14/Effects/ship_start.ogg") //OE14 sound replaced
    {
        Params = AudioParams.Default.WithVolume(-5f),
    };

    private readonly SoundSpecifier _arrivalSound = new SoundPathSpecifier("/Audio/_OE14/Effects/ship_end.ogg") //OE14 sound replaced
    {
        Params = AudioParams.Default.WithVolume(-5f),
    };
    ...
    private void UpdateFTLStarting(Entity<FTLComponent, ShuttleComponent> entity)
    {
        ...
        //DoTheDinosaur(xform); //OE14 without stunning
