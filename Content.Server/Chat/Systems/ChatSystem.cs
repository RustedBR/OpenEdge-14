...
using System.Linq;
using System.Text;
using Content.Server._OE14.Religion;
...
public sealed partial class ChatSystem : SharedChatSystem
{
    ...
    {
        sender ??= Loc.GetString("oe14-announcement-gamemaster"); //OE14 replaced

        var wrappedMessage = Loc.GetString("oe14-announcement-wrapped", ("sender", sender), ("message", FormattedMessage.EscapeText(message))); //OE14 replaced
    ...
    public void DispatchFilteredAnnouncement(
        ...
        Color? colorOverride = null)
    {
        sender ??= Loc.GetString("oe14-announcement-gamemaster"); //OE14 - replaced default sender

        var wrappedMessage = Loc.GetString("oe14-announcement-wrapped", ("sender", sender), ("message", FormattedMessage.EscapeText(message))); //OE14 - replaced default wrapped
