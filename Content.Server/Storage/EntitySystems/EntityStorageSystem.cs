...
using Content.Server._OE14.LockKey;
...
public sealed class EntityStorageSystem : SharedEntityStorageSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<EntityStorageComponent, ActivateInWorldEvent>(OnInteract, after: new[] { typeof(LockSystem), typeof(OE14KeyholeGenerationSystem) });
