...
using Content.Server._OE14.Sponsor;
...
namespace Content.Server.Connection
{
    public interface IConnectionManager
    {
        ...
        Task<bool> HavePrivilegedJoin(NetUserId userId); //OE14 Join Queue
    ...
    public sealed partial class ConnectionManager : IConnectionManager
    {
        ...
        [Dependency] private readonly IOE14SponsorManager _sponsor = default!; //OE14 Priority Join
