...
namespace Content.Server.Construction
{
    public sealed partial class ConstructionSystem
    {
            ...
            Angle angle = default)
        {
            ...
            foreach (var step in edge.Steps)
            {
                ...
                switch (step)
                {
                    ...
                    //OE14 stack group support
                    case OE14StackGroupConstructionGraphStep stackGroupStep:
                        foreach (var entity in new HashSet<EntityUid>(EnumerateNearby(user)))
                        {
        ...
        public async Task<bool> TryStartItemConstruction(string prototype, EntityUid user)
        {
            ...
            //OE14 requirements
            foreach (var req in constructionPrototype.OE14Restrictions)
            {
