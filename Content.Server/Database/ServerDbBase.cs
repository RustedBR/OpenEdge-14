...
namespace Content.Server.Database
{
    public abstract class ServerDbBase
    {
        ...
        private static HumanoidCharacterProfile ConvertProfiles(Profile profile)
        {
            ...
            {
                // OE14: restore stat bonuses from DB
                OE14StatBonusStrength = profile.OE14StatBonusStrength,
                OE14StatBonusVitality = profile.OE14StatBonusVitality,
                OE14StatBonusDexterity = profile.OE14StatBonusDexterity,
                OE14StatBonusIntelligence = profile.OE14StatBonusIntelligence,
            };
        }
        ...
        private static Profile ConvertProfiles(HumanoidCharacterProfile humanoid, int slot, Profile? profile = null)
        {
            ...
            // OE14: persist stat bonuses
            profile.OE14StatBonusStrength = humanoid.OE14StatBonusStrength;
            profile.OE14StatBonusVitality = humanoid.OE14StatBonusVitality;
            profile.OE14StatBonusDexterity = humanoid.OE14StatBonusDexterity;
            profile.OE14StatBonusIntelligence = humanoid.OE14StatBonusIntelligence;
