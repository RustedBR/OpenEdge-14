...
public sealed partial class DungeonSystem : SharedDungeonSystem
{
    ...
    public const int CollisionMask = (int) CollisionGroup.AllMask; //OE14 replace to AllMask
    public const int CollisionLayer = (int) CollisionGroup.AllMask; //OE14 replace to AllMask
