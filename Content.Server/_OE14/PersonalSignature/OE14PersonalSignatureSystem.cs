...
public sealed class OE14PersonalSignatureSystem : EntitySystem
{
    ...
    private bool CanSign(EntityUid? item, [NotNullWhen(true)] out OE14PersonalSignatureComponent? personalSignature)
    {
