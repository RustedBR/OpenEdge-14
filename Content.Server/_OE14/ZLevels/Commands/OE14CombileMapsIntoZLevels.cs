...
namespace Content.Server._OE14.ZLevels.Commands;

[AdminCommand(AdminFlags.VarEdit)]
public sealed class OE14CombineMapsIntoZLevelsCommand : LocalizedCommands
{
    [Dependency] private readonly IEntityManager _entities = default!;
    [Dependency] private readonly IMapManager _map = default!;

    private const string Name = "oe14-combineMapsIntoZLevels";
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        var query = _entities.EntityQueryEnumerator<OE14StationZLevelsComponent>();
        ...
        _entities.EnsureComponent<OE14StationZLevelsComponent>(zLevelEnt, out var newZLevelComp);
