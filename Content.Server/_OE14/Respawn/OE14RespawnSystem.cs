...
using Content.Shared._OE14.Respawn;
...
namespace Content.Server._OE14.Respawn;

public sealed partial class OE14RespawnSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<GhostComponent, OE14RespawnAction>(OnRespawnAction);
        SubscribeLocalEvent<OE14PlayerSpawnAttemptEvent>(OnBeforePlayerSpawn);
    ...
    private void OnBeforePlayerSpawn(OE14PlayerSpawnAttemptEvent ev)
    {
        ...
        if (usedCharacters.Contains(ev.Profile.Name))
        {
            ...
            _chat.DispatchFilteredAnnouncement(
                filter,
                Loc.GetString("oe14-respawn-same-char-bloked"),
    ...
    private void OnRespawnAction(Entity<GhostComponent> ent, ref OE14RespawnAction args)
    {
...
/// </summary>
[PublicAPI]
public sealed class OE14PlayerSpawnAttemptEvent(
