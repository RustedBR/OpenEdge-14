...
[RegisterComponent, Access(typeof(OE14FireplaceSystem))]
public sealed partial class OE14FireplaceComponent : Component
{
    [DataField]
    ...
    [DataField]
    public SoundSpecifier InsertFuelSound = new SoundPathSpecifier("/Audio/_OE14/Items/campfire_whoosh.ogg");
}
