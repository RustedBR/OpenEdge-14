...
public sealed partial class OE14TemperatureSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<OE14TemperatureTransformationComponent, OnTemperatureChangeEvent>(OnTemperatureChanged);
    }

    private void OnTemperatureChanged(Entity<OE14TemperatureTransformationComponent> start,
    ...
    private float GetTargetTemperature(FlammableComponent flammable, OE14FlammableSolutionHeaterComponent heater)
    {
    ...
    {
        var query = EntityQueryEnumerator<OE14SolutionTemperatureComponent, SolutionContainerManagerComponent>();
    ...
    {
        var flammableQuery =
            EntityQueryEnumerator<OE14FlammableEntityHeaterComponent, ItemPlacerComponent, FlammableComponent>();
    ...
    {
        var query =
            EntityQueryEnumerator<OE14FlammableSolutionHeaterComponent, ItemPlacerComponent, FlammableComponent>();
