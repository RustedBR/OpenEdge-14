...
using Content.Shared._OE14.WeatherEffect.Effects;
...
namespace Content.Server._OE14.WeatherEffect;

public sealed class OE14WeatherEffectJob : Job<bool>
{
    ...
    private readonly OE14WeatherEffectConfig _config;
    ...
    public OE14WeatherEffectJob(
        ...
        MapId mapId,
        OE14WeatherEffectConfig config,
