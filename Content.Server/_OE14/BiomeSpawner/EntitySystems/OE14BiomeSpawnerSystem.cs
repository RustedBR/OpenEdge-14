...
using System.Linq;
using Content.Server._OE14.BiomeSpawner.Components;
...
namespace Content.Server._OE14.BiomeSpawner.EntitySystems;

public sealed class OE14BiomeSpawnerSystem : EntitySystem
{
    ...
    {
        SubscribeLocalEvent<OE14BiomeSpawnerComponent, MapInitEvent>(OnMapInit);
    ...
    private void OnMapInit(Entity<OE14BiomeSpawnerComponent> ent, ref MapInitEvent args)
    {
        SpawnBiome(ent);
        QueueDel(ent);
    }
    ...
    private void SpawnBiome(Entity<OE14BiomeSpawnerComponent> ent)
    {
