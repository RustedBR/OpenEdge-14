...
public sealed partial class OE14CurrencySystem
{
    [Dependency] private readonly TagSystem _tag = default!;
    private void InitializeConverter()
    {
        SubscribeLocalEvent<OE14CurrencyConverterComponent, GetVerbsEvent<Verb>>(OnGetVerb);
        SubscribeLocalEvent<OE14CurrencyConverterComponent, ExaminedEvent>(OnConverterExamine);
        SubscribeLocalEvent<OE14CurrencyConverterComponent, InteractUsingEvent>(OnInteractUsing);
    }

    private void OnGetVerb(Entity<OE14CurrencyConverterComponent> ent, ref GetVerbsEvent<Verb> args)
    {
        ...
        Verb copperVerb = new()
        {
            Text = Loc.GetString("oe14-currency-converter-get-cp"),
            Icon = new SpriteSpecifier.Rsi(new ("/Textures/_OE14/Objects/Economy/cp_coin.rsi"), "coin10"),
            Category = VerbCategory.OE14CurrencyConvert,
            Priority = 1,
            CloseMenu = false,
            Act = () =>
            {
        ...
        Verb silverVerb = new()
        {
            Text = Loc.GetString("oe14-currency-converter-get-sp"),
            Icon = new SpriteSpecifier.Rsi(new ("/Textures/_OE14/Objects/Economy/sp_coin.rsi"), "coin10"),
            Category = VerbCategory.OE14CurrencyConvert,
            Priority = 2,
            CloseMenu = false,
            Act = () =>
        ...
        Verb goldVerb = new()
        {
            Text = Loc.GetString("oe14-currency-converter-get-gp"),
            Icon = new SpriteSpecifier.Rsi(new ("/Textures/_OE14/Objects/Economy/gp_coin.rsi"), "coin10"),
            Category = VerbCategory.OE14CurrencyConvert,
            Priority = 3,
            CloseMenu = false,
            Act = () =>
        ...
        {
            Text = Loc.GetString("oe14-currency-converter-get-pp"),
            Icon = new SpriteSpecifier.Rsi(new ("/Textures/_OE14/Objects/Economy/pp_coin.rsi"), "coin10"),
            Category = VerbCategory.OE14CurrencyConvert,
            Priority = 4,
            CloseMenu = false,
            Act = () =>
    ...
    private void OnConverterExamine(Entity<OE14CurrencyConverterComponent> ent, ref ExaminedEvent args)
    {
        var push =
            $"{Loc.GetString("oe14-currency-converter-examine-title")} {GetCurrencyPrettyString(ent.Comp.Balance)}";
        args.PushMarkup(push);
    }

    private void OnInteractUsing(Entity<OE14CurrencyConverterComponent> ent, ref InteractUsingEvent args)
    {
        ...
        _popup.PopupEntity(Loc.GetString("oe14-currency-converter-insert", ("cash", delta)), ent, args.User);
