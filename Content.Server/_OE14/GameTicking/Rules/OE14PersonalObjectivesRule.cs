...
public sealed class OE14PersonalObjectivesRule : GameRuleSystem<OE14PersonalObjectivesRuleComponent>
{
    ...
    {
        var query = EntityQueryEnumerator<OE14PersonalObjectivesRuleComponent>();
    ...
    protected override void AppendRoundEndText(EntityUid uid,
        OE14PersonalObjectivesRuleComponent component,
        ...
        ref RoundEndTextAppendEvent args)
    {
        ...
        sb.Append($"[head=2]{Loc.GetString("oe14-objective-issuer-personal")}[/head]\n");
        ...
        foreach (var (mind, objectives) in component.PersonalObjectives)
        {
            ...
            var name = mindComp.CharacterName ?? Loc.GetString("oe14-objective-unknown");
            var role = Loc.GetString("oe14-objective-unknown");
            var ckey = Loc.GetString("oe14-objective-unknown");
