using Content.Server._OE14.Alchemy.Components;
...
namespace Content.Server._OE14.Alchemy.EntitySystems;

public sealed partial class OE14SolutionCleanerSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<OE14SolutionCleanerComponent, SolutionContainerManagerComponent>();
