...
public sealed partial class  OE14AlchemyExtractionSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<OE14MortarComponent, InteractUsingEvent>(OnInteractUsing);
    }

    private void OnInteractUsing(Entity<OE14MortarComponent> mortar, ref InteractUsingEvent args)
    {
        if (!TryComp<OE14PestleComponent>(args.Used, out var pestle))
            return;
