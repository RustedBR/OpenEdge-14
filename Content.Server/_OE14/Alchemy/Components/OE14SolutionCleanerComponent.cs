using Content.Server._OE14.Alchemy.EntitySystems;
using Content.Shared.FixedPoint;
using Robust.Shared.Audio;

namespace Content.Server._OE14.Alchemy.Components;

/// <summary>
/// gradually rounds down all reagents in the specified solution
/// </summary>
[RegisterComponent, Access(typeof(OE14SolutionCleanerSystem))]
public sealed partial class OE14SolutionCleanerComponent : Component
{
