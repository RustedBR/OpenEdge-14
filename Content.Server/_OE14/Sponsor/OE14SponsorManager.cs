...
using Content.Server._OE14.Discord;
...
namespace Content.Server._OE14.Sponsor;

public sealed class SponsorSystem : IOE14SponsorManager
{
    ...
    private Dictionary<NetUserId, OE14SponsorRolePrototype> _cachedSponsors = new();

    public void Initialize()
    {
        _sawmill = Logger.GetSawmill("sponsors");

        _netManager.RegisterNetMessage<OE14SponsorRoleUpdate>();
    ...
    private async Task OnPlayerVerified(ICommonSession e)
    {
        ...
        OE14SponsorRolePrototype? targetRole = null;
        foreach (var role in _proto.EnumeratePrototypes<OE14SponsorRolePrototype>())
        {
        ...
        {
            e.Channel.SendMessage(new OE14SponsorRoleUpdate
            {
                Role = cachedRole,
            });
        }
