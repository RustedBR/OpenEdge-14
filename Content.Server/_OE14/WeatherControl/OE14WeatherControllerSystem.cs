...
public sealed class OE14WeatherControllerSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<OE14WeatherControllerComponent>();
    ...
    private OE14WeatherData? PickWeatherDataByWeight(EntityUid map, HashSet<OE14WeatherData> entries)
    {
        var filteredEntries = new HashSet<OE14WeatherData>(entries);
