using Content.Shared._OE14.StatusEffect;
...
public sealed partial class OE14EntityEffectsStatusEffectSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<OE14EntityEffectsStatusEffectComponent, StatusEffectComponent>();
