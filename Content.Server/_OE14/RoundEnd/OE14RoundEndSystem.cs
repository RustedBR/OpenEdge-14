...
public sealed partial class OE14RoundEndSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<OE14MagicContainerRoundFinisherComponent, OE14MagicEnergyLevelChangeEvent>(OnFinisherMagicEnergyLevelChange);
    ...
    public override void Update(float frameTime)
    {
        ...
        _chatSystem.DispatchGlobalAnnouncement(Loc.GetString("oe14-round-end"),
            announcementSound: new SoundPathSpecifier("/Audio/_OE14/Announce/event_boom.ogg"));
        _roundEnd.EndRound();
        _roundEndMoment = TimeSpan.Zero;
    }

    private void OnFinisherMagicEnergyLevelChange(Entity<OE14MagicContainerRoundFinisherComponent> ent,
        ref OE14MagicEnergyLevelChangeEvent args)
    {
        ...
        if (args.NewValue < args.OldValue && args.OldValue > args.MaxValue / 2 && args.NewValue <= args.MaxValue / 2)
        {
            _chatSystem.DispatchGlobalAnnouncement(
                Loc.GetString("oe14-round-end-monolith-50"),
                announcementSound: new SoundPathSpecifier("/Audio/_OE14/Announce/event_boom.ogg"));
        }
    ...
    {
        var roundEndDelay = TimeSpan.FromMinutes(_cfg.GetCVar(CCVars.OE14RoundEndMinutes));
        ...
        _chatSystem.DispatchGlobalAnnouncement(
            Loc.GetString(
                "oe14-round-end-monolith-discharged",
                ("time", time),
    ...
    private void CancelRoundEndTimer()
    {
        ...
        _chatSystem.DispatchGlobalAnnouncement(Loc.GetString("oe14-round-end-monolith-recharged"),
            announcementSound: new SoundPathSpecifier("/Audio/_OE14/Announce/event_boom.ogg"));
    }
}
