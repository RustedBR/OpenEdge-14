using Content.Server._OE14.ModularCraft;
...
namespace Content.Server._OE14.Chemistry.SmokeBomb;

[Serializable]
[DataDefinition]
public sealed partial class OE14AreaEffectBehavior : IThresholdBehavior
{
    [DataField]
    public string? Solution;

    [DataField]
    public EntProtoId SmokeProto = "OE14Mist";
