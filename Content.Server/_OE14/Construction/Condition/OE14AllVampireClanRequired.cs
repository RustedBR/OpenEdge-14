...
[UsedImplicitly]
[DataDefinition]
public sealed partial class OE14AllVampireClanRequired : IGraphCondition
{
    ...
    public bool Condition(EntityUid craft, IEntityManager entityManager)
    {
        ...
        var query = entityManager.EntityQueryEnumerator<OE14VampireComponent, TransformComponent>();
    ...
    public bool DoExamine(ExaminedEvent args)
    {
        ...
        args.PushMarkup(Loc.GetString("oe14-magic-spell-need-all-vampires"));
        return true;
    }
    ...
    public IEnumerable<ConstructionGuideEntry> GenerateGuideEntry()
    {
        ...
        {
            Localization = "oe14-magic-spell-need-all-vampires",
            Icon = new SpriteSpecifier.Rsi(new ResPath("/Textures/_OE14/Actions/Spells/vampire.rsi"), "blood_moon"),
        };
    }
}
