...
namespace Content.Server._OE14.DPSMeter;

public sealed class OE14DPSMeterSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<OE14DPSMeterComponent, DamageChangedEvent>(OnDamageChanged);
    }
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<OE14DPSMeterComponent>();
    ...
    private void OnDamageChanged(Entity<OE14DPSMeterComponent> ent, ref DamageChangedEvent args)
    {
    ...
    private FixedPoint2 GetDPS(Entity<OE14DPSMeterComponent> ent)
    {
