using Content.Server._OE14.DeviceLinking.Components;
using Content.Server.DeviceLinking.Systems;
using Content.Shared._OE14.DeviceLinking;
...
namespace Content.Server._OE14.DeviceLinking;

public sealed class OE14PressurePlateSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<OE14PressurePlateComponent, ComponentInit>(OnInit);
        SubscribeLocalEvent<OE14PressurePlateComponent, ItemPlacedEvent>(OnItemPlaced);
        SubscribeLocalEvent<OE14PressurePlateComponent, ItemRemovedEvent>(OnItemRemoved);
    }

    private void OnInit(Entity<OE14PressurePlateComponent> plate, ref ComponentInit args)
    {
    ...
    private void OnItemRemoved(Entity<OE14PressurePlateComponent> plate, ref ItemRemovedEvent args)
    {
        UpdateState(plate);
    }

    private void OnItemPlaced(Entity<OE14PressurePlateComponent> plate, ref ItemPlacedEvent args)
    {
        UpdateState(plate);
    }

    private void UpdateState(Entity<OE14PressurePlateComponent> plate)
    {
