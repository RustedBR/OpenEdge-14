...
public sealed class OE14SpawnProceduralLocationJob(
    double maxTime,
    ...
    Vector2i position,
    int seed,
    ProtoId<OE14ProceduralLocationPrototype> config,
    List<ProtoId<OE14ProceduralModifierPrototype>> modifiers,
    string? jobName = null,
    ...
    : Job<bool>(maxTime, cancellation)
{
    ...
    private readonly ISawmill _sawmill = logManager.GetSawmill("oe14_procedural_location_job");
    ...
    protected override async Task<bool> Process()
    {
        ...
        dungeonConfig.Layers.Add(new OE14ReserveGrid());
