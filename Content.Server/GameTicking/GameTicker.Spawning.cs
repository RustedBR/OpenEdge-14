...
using Content.Server._OE14.Respawn;
...
namespace Content.Server.GameTicking
{
    public sealed partial class GameTicker
    {
            ...
            bool silent = false)
        {
            ...
            //OE14 blocking rejoining to game with same character
            var OE14Ev = new OE14PlayerSpawnAttemptEvent(player, character, jobId, lateJoin, station);
            RaiseLocalEvent(OE14Ev);
            if (OE14Ev.Cancelled)
                return;
            //OE14 end
            ...
            if (lateJoin && !silent && false) //OE14 disable arrival snnouncement
            {
