...
namespace Content.Server.Ghost
{
    public sealed class GhostSystem : SharedGhostSystem
    {
        ...
        private void OnGhostShutdown(EntityUid uid, GhostComponent component, ComponentShutdown args)
        {
            ...
            _eye.RefreshVisibilityMask(uid);
            //_actions.RemoveAction(uid, component.BooActionEntity);  //Dont need in OE14
        }

        private void OnMapInit(EntityUid uid, GhostComponent component, MapInitEvent args)
        {
            //_actions.AddAction(uid, ref component.BooActionEntity, component.BooAction); //Dont need in OE14
            //_actions.AddAction(uid, ref component.ToggleGhostHearingActionEntity, component.ToggleGhostHearingAction); //Dont need in OE14
            _actions.AddAction(uid, ref component.ToggleLightingActionEntity, component.ToggleLightingAction);
            _actions.AddAction(uid, ref component.ToggleFoVActionEntity, component.ToggleFoVAction);
            _actions.AddAction(uid, ref component.ToggleGhostsActionEntity, component.ToggleGhostsAction);
            //OE14
            _actions.AddAction(uid, ref component.OE14ToggleRoofActionEntity, component.OE14ToggleRoofAction);
            _actions.AddAction(uid, ref component.OE14RespawnActionEntity, component.OE14RespawnAction);
            //OE14 end
        }
