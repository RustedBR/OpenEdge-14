...
public sealed class VocalSystem : EntitySystem
{
    ...
    private void OnMapInit(EntityUid uid, VocalComponent component, MapInitEvent args)
    {
        ...
        //_actions.AddAction(uid, ref component.ScreamActionEntity, component.ScreamAction); //OE14 Remove The Scream Action from the Action bar
    ...
    private void OnShutdown(EntityUid uid, VocalComponent component, ComponentShutdown args)
    {
        ...
        {
            //_actions.RemoveAction(uid, component.ScreamActionEntity);  //OE14 Remove The Scream Action from the Action bar
        }
    }
